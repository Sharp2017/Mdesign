...
{
    public partial class b_sourcelist : System.Web.UI.Page
    {
        ...
        private void showgrid(object sender, System.EventArgs e)
        {
            ...
            mydt = AccessDb.Execute("select * from t_service  order by id desc").Tables[0];
        ...
        {
            string SaveCountList = ConfigurationManager.AppSettings.Get("ServiceCount");
        ...
        protected void DGList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                e.Item.Cells[9].Attributes.Add("onclick", "return confirm('你确定要删除吗？');");
        ...
        protected void DGList_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            try
            {
                string sql = "delete from t_service where id=" + nowRow.ToString();
        ...
        protected void btnSaveCountList_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (appSetting.Settings["ServiceCount"] == null)
                {

                    appSetting.Settings.Add("ServiceCount", this.txtSaveCountList.Text.ToString().Trim());
                ...
                else//否则修改
                {
                    ...
                    appSetting.Settings["ServiceCount"].Value = this.txtSaveCountList.Text.ToString().Trim();
