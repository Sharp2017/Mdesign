<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="b_questionList.aspx.cs" Inherits="Mdesign.manage.b_questionList" %>
...
<body class="main">
    ...
    <div id="mainDiv" style="background-color: #fffff0">
        <table class="tmain" style="width: 880px;">
                    ...
                    <td class="listTd">
                        <asp:DataGrid ID="DGList" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="ptitle" HeaderText="问题题目"></asp:BoundColumn>
								 <asp:HyperLinkColumn Target="_blank" DataNavigateUrlField="ppic" DataNavigateUrlFormatString="{0}"
                                    DataTextField="ppic" HeaderText="图片" Visible="False"></asp:HyperLinkColumn>
							
								<asp:BoundColumn  DataField="pdate" HeaderText="日期"><ItemStyle HorizontalAlign="Left" Width="150px"></ItemStyle>		</asp:BoundColumn>
									 	
                                <asp:BoundColumn DataField="pAnswered" HeaderText="回答情况"></asp:BoundColumn>
									 	
                                <asp:HyperLinkColumn Target="_self" DataNavigateUrlField="id" DataNavigateUrlFormatString="b_questionadd.aspx?id={0}"
           ...
           <input type="button" style="width: 80px; height: 30px" value="添加" 
                        onclick="window.location.href='b_questionAdd.aspx'" />
                        </div>
                </td>
                </tr>
            </tbody>
