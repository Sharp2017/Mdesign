<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="b_topnewsList.aspx.cs" Inherits="Mdesign.manage.b_topnewsList" %>
...
<body class="main">
						...
						<TD class="listTd"  >
                         <asp:datagrid id="DGList" runat="server" Width="100%" 
								...
								<Columns>
									...
									<asp:BoundColumn  DataField="purl" HeaderText="链接地址"><ItemStyle HorizontalAlign="Left" Width="130"></ItemStyle>		</asp:BoundColumn>
									 
									<asp:BoundColumn  DataField="ppic" HeaderText="图片地址"><ItemStyle HorizontalAlign="Left" Width="150px"></ItemStyle>		</asp:BoundColumn>
								 
								 
									 <asp:BoundColumn DataField="PIsShow" HeaderText="是否显示"></asp:BoundColumn>
									
									<asp:BoundColumn DataField="psort" HeaderText="排序"></asp:BoundColumn>
									
									<asp:HyperLinkColumn Target=_self  DataNavigateUrlField="id" DataNavigateUrlFormatString="b_topnews.aspx?id={0}"
    ...
    <input type=button   style="width:80px;height:30px"  value="添加" onclick="window.location.href='b_topnews.aspx'"/></div>
