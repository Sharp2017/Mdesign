<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="b_aboutPlat2.aspx.cs" Inherits="Mdesign.manage.b_aboutPlat2" %>
<%@ Register src="b_aboutplatMenu.ascx" tagname="b_aboutplatMenu" tagprefix="uc1" %>
...
<script>
    KE.show({
		...
		'insertunorderedlist', '|', 'emoticons', 'image', 'link']
			...
			<script>			    writeTitle('平台简介', 'role.gif');</script>
			
			<uc1:b_aboutplatMenu ID="b_aboutplatMenu1" runat="server" />
