<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="b_mainNewsPic.aspx.cs" Inherits="Mdesign.manage.b_mainNewsPic" %>
...
<script>
    KE.show({
		...
		'insertunorderedlist', '|', 'emoticons', 'image', 'link']
			...
			<script>			    writeTitle('首页新闻右侧', 'role.gif');</script>
			...
			<TABLE class="tmain" width=100%>
				...
				<tr>
						<TD class="listTd" vAlign="top" colSpan="2">
							 <textarea id="content2" name="content" style="width:100%;height:440px;visibility:hidden;" runat=server ></textarea>
						</TD>
					</tr>
					<tr>
